  ...
  return (
    <>
      <div className="max-w-screen-2xl container mx-auto md:px-20 px-4 flex flex-col md:flex-row my-10">
        <div className="left md:order-1 order-2 w-full  md:w-1/2 mt-12 md:mt-32">
          <div className="space-y-12">
            <h1 className="font-bold text-4xl ">
              Hello welcom here to learn Somthing{" "}
        ...
        <div className="md:order-1 right w-full  md:w-1/2">
          <img className="w-92 h-92 " src={img} />
        </div>
      </div>
    </>
  );
